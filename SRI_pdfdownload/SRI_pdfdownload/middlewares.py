...
class SriPdfdownloadSpiderMiddleware:
...
class SriPdfdownloadDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class ChangeProxy(object):
    ...
    def process_request(self, request, spider):
        ...
        return HtmlResponse(url=request.url, body=res.content, encoding='utf8', request=request)
